...
CREATE TABLE `reservation_guest` (
  ...
  KEY `fk_reservation_guest_guest_idx` (`id_guest`),
  CONSTRAINT `fk_reservation_guest_guest` FOREIGN KEY (`id_guest`) REFERENCES `guest` (`id`),
  CONSTRAINT `fk_reservation_guest_reservation` FOREIGN KEY (`id_reservation`) REFERENCES `reservation` (`id`)
...
-- Dump completed on 2026-04-21 19:04:43
